...
void rst::rasterizer::rasterize_triangle(const Triangle& t, const std::array<Eigen::Vector3f, 3>& view_pos) 
{
    ...
    auto x_min = std::min(std::min(t.v[0].x(), t.v[1].x()), t.v[2].x());
    auto x_max = std::max(std::max(t.v[0].x(), t.v[1].x()), t.v[2].x());
    auto y_min = std::min(std::min(t.v[0].y(), t.v[1].y()), t.v[2].y());
    auto y_max = std::max(std::max(t.v[0].y(), t.v[1].y()), t.v[2].y());
