...
{   
    ...
    Vector3f line1 = _v[1] - _v[0];
    Vector3f line2 = _v[2] - _v[1];
    Vector3f line3 = _v[0] - _v[2];
    Vector3f point = Vector3f(x, y, 0);
    Vector3f cross1 = line1.cross(point - _v[0]);
    Vector3f cross2 = line2.cross(point - _v[1]);
    Vector3f cross3 = line3.cross(point - _v[2]);
